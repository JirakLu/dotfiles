...
static const Key keys[] = {
	...
	{ 0,							XK_Print,						spawn,			SHCMD ("flameshot full -p $HOME/Screenshots/")},
	{ MODKEY|ShiftMask,				XK_Print,						spawn,			SHCMD ("flameshot gui -p $HOME/Screenshots/")},
	{ MODKEY|ControlMask,			XK_Print,						spawn,			SHCMD ("flameshot gui --clipboard")},
